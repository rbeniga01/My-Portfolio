    ...
    return (
        <section id="services" className="py-24 bg-black/50">
            <div className="container mx-auto px-6">
                <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 font-['Space_Grotesk']">Work With Me</h2>
                ...
                <p className="text-center text-white/80 mb-12 max-w-3xl mx-auto">
                    I'm available for freelance projects, custom builds, and full-time opportunities. Let's create something impactful together.
                </p>
